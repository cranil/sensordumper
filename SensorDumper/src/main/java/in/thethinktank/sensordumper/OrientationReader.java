 ...
 */
public class OrientationReader implements SensorReader, SensorEventListener {
    ...
    OrientationReader(SensorManager sensorManager, File dumpFile) throws RuntimeException {
    ...
    OrientationReader(SensorManager sensorManager, PrintWriter printWriter) throws RuntimeException {
        mSensorManager = sensorManager;
        mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD);
    ...
    public void dump(long millisecondsStartAt, long millisecondsRate) {
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                synchronized (OrientationReader.this) {
                    OrientationReader.this.dump();
                }
            }
